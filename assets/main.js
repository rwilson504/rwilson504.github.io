...
(function ($) {
    ...
    //   request.send($(this).serialize());
      ...
      $.ajax({
        ...
        //crossDomain: true,
        data: $(this).serialize(),
        headers: {"Access-Control-Allow-Origin": "*", "Access-Control-Allow-Methods": "GET,HEAD,OPTIONS,POST,PUT", "Access-Control-Allow-Headers": "Origin, X-Requested-With, Content-Type, Accept, Authorization"},                
