---
title: "Passing Pipeline Trigger Time to Data Flows in Azure Data Factory: Use Strings, Not Timestamps!"
description: "When working with Azure Data Factory (ADF) and the Dataverse connector, passing the pipeline trigger time into a Data Flow can be trickier than expected."
pubDate: 2025-08-18
heroImage: "/heroes/passing-pipeline-trigger-time-to-data.png"
heroImageAlt: "Passing Pipeline Trigger Time to Data Flows in Azure Data Factory: Use Strings, Not Timestamps!"
category: power-apps
tags:
  - "adftips"
  - "automateddata"
  ...
  - "webapi"
draft: false
originalBloggerUrl: /2025/08/passing-pipeline-trigger-time-to-data.html
---
...
![Azure Data Factory error details showing a timestamp parameter incompatibility in a Dataverse data flow](/images/passing-pipeline-trigger-time-to-data/01-abbb0756-0507-4d4d-8673-e6bd21bbdbc9.png)

### The Solution

1. **Define the Data Flow parameter as a `string`.**  
   ![Azure Data Factory data flow parameter defined as a string for trigger time](/images/passing-pipeline-trigger-time-to-data/02-5a88fdea-b987-4314-a75c-e30c609b7196.png)
2. In the pipeline, pass the `@pipeline().TriggerTime` system variable directly into this parameter using a pipeline expression.  
   ![Azure Data Factory pipeline passing @pipeline().TriggerTime into the data flow string parameter](/images/passing-pipeline-trigger-time-to-data/03-c53057c5-f92c-4adc-8f88-18ba8a11426a.png)
