...
![Logic App code view with accessControl JSON disabling SAS authentication for triggers](/images/locking-down-logic-app-consumption-with/01-b1c32b30-4139-454d-b3b9-6326ed089148.png)
...
![Logic App Authorization page with an OAuth policy using issuer and audience claims](/images/locking-down-logic-app-consumption-with/02-a49e65d3-f1da-46f2-9ce5-de6868c991f4.png)
...
![OAuth policy custom claim appid added to restrict access to a specific managed identity](/images/locking-down-logic-app-consumption-with/03-c53fd358-2de6-4925-a106-f1f07d05d3a3.png)
...
⚠️ **Note:** Output the **entire token** (not truncated) if you want to paste it into **[jwt.ms](http://jwt.ms)** for inspection of `iss` and `aud`. Also make sure to remove this tracing before deployment.
